...
final class Container
{
    ...
    public static function get(string $name): mixed
    {
        return match (true) {
            ...
            Runtime::isLaravel() => \Illuminate\Container\Container::get($name),
    ...
    public static function has(string $name): bool
    {
        return match (true) {
            ...
            Runtime::isLaravel() => \Illuminate\Container\Container::has($name),
            default => throw new UnsupportedRuntime(),
        };
    }
    ...
    public static function make(string $name, array $parameters = []): mixed
    {
        return match (true) {
            ...
            Runtime::isLaravel() => \Illuminate\Container\Container::make($name, $parameters),
            default => throw new UnsupportedRuntime(),
        };
    }
}
